...
**Tips:**
- Use `Glob` first to discover file structure (e.g., `**/*.ts` in relevant directories)
...
You may use `Glob`, `Grep`, and `Read` during plan generation to look up additional code details as needed.
